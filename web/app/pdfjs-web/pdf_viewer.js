...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    factory(exports, require('pdfjs-web/ui_utils.js'), require('pdfjs-web/pdf_page_view.js'),
      require('pdfjs-web/pdf_rendering_queue.js'), require('pdfjs-web/text_layer_builder.js'),
      require('pdfjs-web/annotation_layer_builder.js'),
      require('pdfjs-web/pdf_link_service.js'), require('pdfjs-web/dom_events.js'),
      require('pdfjs-web/pdfjs.js'));
  } else {
