...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'Old/ui_utils',
      'Old/download_manager', 'Old/pdf_history',
      'Old/preferences', 'Old/pdf_sidebar',
      'Old/view_history', 'Old/pdf_thumbnail_viewer',
      'Old/secondary_toolbar', 'Old/password_prompt',
      'Old/pdf_presentation_mode', 'Old/pdf_document_properties',
      'Old/hand_tool', 'Old/pdf_viewer',
      'Old/pdf_rendering_queue', 'Old/pdf_link_service',
      'Old/pdf_outline_viewer', 'Old/overlay_manager',
      'Old/pdf_attachment_viewer', 'Old/pdf_find_controller',
      'Old/pdf_find_bar', 'Old/dom_events', 'Old/pdfjs'],
      factory);
  } else if (typeof exports !== 'undefined') {
    factory(exports, require('Old/ui_utils.js'), require('Old/download_manager.js'),
      require('Old/pdf_history.js'), require('Old/preferences.js'),
      require('Old/pdf_sidebar.js'), require('Old/view_history.js'),
      require('Old/pdf_thumbnail_viewer.js'), require('Old/secondary_toolbar.js'),
      require('Old/password_prompt.js'), require('Old/pdf_presentation_mode.js'),
      require('Old/pdf_document_properties.js'), require('Old/hand_tool.js'),
      require('Old/pdf_viewer.js'), require('Old/pdf_rendering_queue.js'),
      require('Old/pdf_link_service.js'), require('Old/pdf_outline_viewer.js'),
      require('Old/overlay_manager.js'), require('Old/pdf_attachment_viewer.js'),
      require('Old/pdf_find_controller.js'), require('Old/pdf_find_bar.js'),
      require('Old/dom_events.js'), require('Old/pdfjs.js'));
  } else {
