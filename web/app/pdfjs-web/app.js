...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    define(['exports', 'pdfjs-web/ui_utils',
    ...
    factory(exports, require('pdfjs-web/ui_utils.js'), require('pdfjs-web/download_manager.js'),
      require('pdfjs-web/pdf_history.js'), require('pdfjs-web/preferences.js'),
      require('pdfjs-web/pdf_sidebar.js'), require('pdfjs-web/view_history.js'),
      require('pdfjs-web/pdf_thumbnail_viewer.js'), require('pdfjs-web/secondary_toolbar.js'),
      require('pdfjs-web/password_prompt.js'), require('pdfjs-web/pdf_presentation_mode.js'),
      require('pdfjs-web/pdf_document_properties.js'), require('pdfjs-web/hand_tool.js'),
      require('pdfjs-web/pdf_viewer.js'), require('pdfjs-web/pdf_rendering_queue.js'),
